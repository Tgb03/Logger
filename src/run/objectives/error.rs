...
impl<'a> Display for ObjectiveParseError {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    match self {
      ObjectiveParseError::IncompatibleType(obj_type) => write!(f, "Incompatible type passed: {}", obj_type),
      ObjectiveParseError::FailedParseIntoGameObjective => write!(f, "Failed to parse &str into GameRunObjective"),
      ObjectiveParseError::FailedParseIntoGameRundown => write!(f, "Failed to parse &str into GameRunRundown"),
